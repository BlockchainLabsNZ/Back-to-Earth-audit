...
contract("STRC", function(accounts) {
  beforeEach(async () => {
    ...
    //(miniMeTokenFactory.address, { from: accounts[0] });
    //await strc.enableTransfers(true, { from: accounts[0] });
    //strc.generateTokens(accounts[0], 100000000000000000000);
    //await strc.changeController("0x0");
  });
